...
{
    stringstream output;
    output << "mtsab " << IOP::REG(RS) << ", " << (uint16_t)IMM;
    return output.str();
}
...
{
    stringstream output;
    output << "mtsah " << IOP::REG(RS) << ", " << (uint16_t)IMM;
    return output.str();
}
...
string disasm_cop_move(string opcode, uint32_t instruction)
{
    ...
    output << opcode << cop_id << " " << IOP::REG(RT) << ", "
           << RD;
...
string disasm_cop2_qmove(const string opcode, uint32_t instruction)
{
    ...
    if (instruction & 1)
        output << ".i";
    output << " " << IOP::REG(RT) << ", vf" << ((instruction >> 11) & 0x1F);
    return output.str();
}
...
{
    stringstream output;
    output << "pext5 " << IOP::REG(RD) << ", " << IOP::REG(RT);
    return output.str();
}
...
{
    stringstream output;
    output << "pabsw " << IOP::REG(RD) << ", " << IOP::REG(RT);
    return output.str();
}
...
{
    stringstream output;
    output << "pabsh " << IOP::REG(RD) << ", " << IOP::REG(RT);
    return output.str();
}
